...
<html>
  <#assign hasSingleUsername = usernames?size == 1>
  <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>
      <#if hasSingleUsername>
        ${kcSanitize(msg("emailForgotUsernameTitleSingular"))}
      <#else>
        ${kcSanitize(msg("emailForgotUsernameTitlePlural"))}
      </#if>
    </title>
  </head>
                  ...
                  <tr>
                    <td class="content-cell" style="${baseTableDataPaddedStyles}">
                      <h2 style="${headingStyles}" align="left">
                        ${kcSanitize(msg("emailForgotUsernameGreeting"))}
                      </h2>

                      <p style="${baseParagraphStyles}" align="left">
                        <#if hasSingleUsername>
                          ${kcSanitize(msg("emailForgotUsernameBodySingular"))}
                        <#else>
                          ${kcSanitize(msg("emailForgotUsernameBodyPlural"))}
                        </#if>
                      </p>
                      ...
                      <p style="${baseParagraphStyles}" align="left">
                        ${msg("emailForgotUsernameBodyNotYouHtml")?no_esc}
                      </p>
