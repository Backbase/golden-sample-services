...
//    isValidProductId(productId);
    ...
    return repository.findById(productId).map(mapper::entityToApi).orElseThrow(() -> new NotFoundException(productId));
  }
...
//    isValidProductId(productId);
    ...
    ProductEntity book = repository.findById(productId)
