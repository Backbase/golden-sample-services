...
/**
 * <p>This class is required to conditionally override primary key generation strategy for the entities.</p>
 * <p>By default entities are configured to use {@link GenerationType#SEQUENCE} which works for Oracle and MSSQL
 * out of the box.</p>
 * <p>When the entities are used for MySql (JDBC URL is checked) we override the primary key generation strategy to
